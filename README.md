...
- `jww+mkbNDVxZ9RXr2zSTOMRURRFJSbwY2baLLS6j0fc=`<!--1066_EXAMPLE_HASH-->

#### Generation of the fixed salt
The salt string itself was generated by a PBKDF2 call with a very high iteration count. For reference, the following parameters were used:
- Password: "HashBack" (8 bytes.)<!--FIXED_SALT_PASSWORD-->
- Salt: "Dedicated to my Treacle. I love you to the moon and back." (57 bytes.)<!--FIXED_SALT_DEDICATION-->
...
- `3LMr4CZZAVJNhlbvBmYinrrStO7j0JUeZWg4F6i3a+I=`<!--CASE_STUDY_HASH-->
