...
The salt string itself was generated by the attached C# program. This calls PBKDF2 but using its own source code as the password, together with a very high iteration count. After a little processing, the program outputs a string of 64 capital letters that was deterministically derived, taking steps to remove repeated letters for aesthetic reasons.
